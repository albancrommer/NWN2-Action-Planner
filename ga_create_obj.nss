...
object oCreature = CreateObject(iObjType, sTemplate, lLocation, bUseAppearAnimation, sNewTag);
    SendMessageToPC( GetFirstPC(), "La créature est valide ? : " + IntToString( GetIsObjectValid( oCreature ) )) ;
	}